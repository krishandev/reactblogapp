...
const CommentSection = ({postId}) => {
    ...
    const handleEdit=async(comment, editedCotent)=>{
        setComments(
            comments.map((c)=>c._id===comment._id?{...c, content:editedCotent}:c)
        )
    }
    ...
    <div className=' max-w-2xl mx-auto w-full p-3'>
        {
            ...
            (
                <div className='flex items-center gap-1 my-5 text-gray-500 text-sm'>
                    ...
                    <Link to={'/dashboard?tap=profile'} className='text-xs text-cyan-600 hover:underline'>
